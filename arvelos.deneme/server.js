...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "insta") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.author.sendMessage("**lastsmokingbender*");
    } else {
      msg.reply("**lastsmokingbender**");
    }
  }
});
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "selamun aleykum") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.author.sendMessage("**burası cami mi orospu çocuğu**");
    } else {
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "am") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.author.sendMessage("**hani nerede lütfen söyle**");
    } else {
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "kız") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.author.sendMessage("**hani nerede lütfen söyle**");
    } else {
      msg.reply("**hani nerede lütfen söyle**");
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "orospucocu") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.author.sendMessage("**aynaya karşı* **");
    } else {
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "mal") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.author.sendMessage("**çok doğru söyledin**");
    } else {
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "aşko") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.author.sendMessage("**doy be adam**");
    } else {
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "ilyas2") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.author.sendMessage("**lastsmokingbender gt**");
    } else {
      msg.reply("**lastsmokingbender gt**");
    }
  }
});
